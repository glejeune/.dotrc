...
if !exists('g:erlCallPath')
  let g:erlCallPath = 'erl_call'
endif
...
function! StartWranglerServer()
    ...
    let command = g:erlCallPath . " -s -sname " . s:erlangServerName . " -x 'erl -pa " . wranglerEbinDir . "'"
    call system(command)
...
function! s:send_rpc(module, fun, args)
    let command = g:erlCallPath . " -sname " . s:erlangServerName . " -a '" . a:module . " " . a:fun . " " . a:args . "'"
...
command! ErlRenameModule call ErlangRenameModule()
